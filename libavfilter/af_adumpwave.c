 ...
 */
static inline void RMS(ADumpwaveContext *adumpwave, const float sample)
{
    double value = 0.;
    if (sample != 0)
...
AVFilter ff_af_adumpwave = {
    .name          = "adumpwave",
    .description   = NULL_IF_CONFIG_SMALL("Dump waveform data to csv file"),
    .init          = init,
    .uninit        = uninit,
    .priv_size     = sizeof(ADumpwaveContext),
    .priv_class    = &adumpwave_class,
